...
<a href={link} target="_blank" rel="noopener noreferrer" class="project-card-link">
	<article class="project-card" bind:this={cardRef}>
		<div class="card-content">
			<div class="header-row">
				<h3 class="project-title">{name}</h3>
				<button type="button" class="github-link" aria-label="View on GitHub" on:click|stopPropagation>
					<svg
